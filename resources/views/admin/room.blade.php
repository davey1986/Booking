            ...
            @foreach($guests as $guest)
              ...
              <div class="card mb-3 card-rounded-footer">
                ...
                <div class="card-body" style="text-align:center;">
                  <!-- <h2 class="card-title">Guest: {{$guest->title}} {{$guest->name}} {{$guest->surname}}</h2> -->
                ...
                <div class="card-footer bg-transparent border-success card-rounded-footer" style="text-align:center; ">
                  ...
                  <div class="row">
                    ...
                    <div class="one-third ">
                      ...
                      @endif
                      <!-- <div ><h4>Cost per night:</h4></div>
                      <div ><h4>R<a id="total">{{$room->cost_per_night}}</a></h4></div> -->
                    </div>
                  </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-2">
                                  <div class="row">
                                    ...
                                    <!-- <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                      <a href="/cancel_reservation/{{$room->id}}/{{$guest->id}}" class="btn btn-primary btn-xs " style="float:right;">Cancel Reservation</a>
                                    </div> -->
                                  </div>
                                </div>
